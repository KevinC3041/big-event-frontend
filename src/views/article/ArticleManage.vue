  ...
  const categories = ref([
    {
      ...
      categoryName: "美食",
      categoryAlias: "my",
      createTime: "2023-09-02 12:06:58",
...
//   添加文章
  ...
  const addArticle = async (clickState) => {
    ...
    // 调用接口
    // console.log("DEBUGING:", articleModel.value);
  ...
  <el-card class="page-container">
    ...
    >
      ...
      <el-form
        :model="articleModel"
        label-width="100px"
        class="custom-drawer-form_style"
      >
        <el-form-item label="文章标题" class="efTitle">
          <el-input
            v-model="articleModel.title"
            placeholder="请输入标题"
          ></el-input>
        </el-form-item>
        <el-form-item label="文章分类" class="efCategory">
          <el-select
            placeholder="请选择"
        ...
        <el-form-item label="文章内容" class="efEditor">
          <div class="editor">
            <quill-editor
              theme="snow"
...
<style lang="scss" scoped>
  ...
  .custom-drawer-form_style {
    ...
    :deep() {
        ...
        .el-form-item.efTitle{
            // background-color: #ff0;
            width:90%;
            min-width: 200px;
        }

        .el-form-item.efCategory{
            // background-color: #ff0;
            width:30%;
            min-width: 200px;
        }

        .el-form-item.efEditor{
            // background-color: #ff0;
            width:90%;
        }
    }
